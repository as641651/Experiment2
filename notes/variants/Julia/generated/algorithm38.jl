...
"""
    algorithm38(ml0::Array{Float64,2}, ml1::Array{Float64,2}, ml2::Array{Float64,2}, ml3::Array{Float64,2}, ml4::Array{Float64,2})
...
function algorithm38(ml0::Array{Float64,2}, ml1::Array{Float64,2}, ml2::Array{Float64,2}, ml3::Array{Float64,2}, ml4::Array{Float64,2})
    ...
    # M4: ml3, full, tmp13: ml5, full, tmp1: ml6, full
    # tmp12 = (tmp1 + M4^T)
    ml6 .+= transpose(ml3)
