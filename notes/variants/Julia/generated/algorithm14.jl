...
"""
    algorithm14(ml0::Array{Float64,2}, ml1::Array{Float64,2}, ml2::Array{Float64,2}, ml3::Array{Float64,2}, ml4::Array{Float64,2})
...
function algorithm14(ml0::Array{Float64,2}, ml1::Array{Float64,2}, ml2::Array{Float64,2}, ml3::Array{Float64,2}, ml4::Array{Float64,2})
    ...
    # M4: ml3, full, tmp2: ml6, symmetric_lower_triangular, tmp3: ml5, full
    for i = 1:1100-1;
