...
"""
    algorithm71(ml0::Array{Float64,2}, ml1::Array{Float64,2}, ml2::Array{Float64,2}, ml3::Array{Float64,2}, ml4::Array{Float64,2})
...
function algorithm71(ml0::Array{Float64,2}, ml1::Array{Float64,2}, ml2::Array{Float64,2}, ml3::Array{Float64,2}, ml4::Array{Float64,2})
    ...
    # M1: ml0, full, M2: ml1, full, M3: ml2, full, tmp8: ml4, full
    ml5 = Array{Float64}(undef, 1100, 1100)
    # tmp2 = (M3 M3^T)
    syrk!('L', 'N', 1.0, ml2, 0.0, ml5)

    # M1: ml0, full, M2: ml1, full, tmp8: ml4, full, tmp2: ml5, symmetric_lower_triangular
    ml6 = Array{Float64}(undef, 1100, 1100)
    # tmp1 = (M1 M2^T)
    gemm!('N', 'T', 1.0, ml0, ml1, 0.0, ml6)

    # tmp8: ml4, full, tmp2: ml5, symmetric_lower_triangular, tmp1: ml6, full
    # tmp4 = (tmp1 + tmp8^T)
    ml6 .+= transpose(ml4)
