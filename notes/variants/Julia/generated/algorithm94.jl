...
"""
    algorithm94(ml0::Array{Float64,2}, ml1::Array{Float64,2}, ml2::Array{Float64,2}, ml3::Array{Float64,2}, ml4::Array{Float64,2})
...
function algorithm94(ml0::Array{Float64,2}, ml1::Array{Float64,2}, ml2::Array{Float64,2}, ml3::Array{Float64,2}, ml4::Array{Float64,2})
    ...
    # M1: ml0, full, M2: ml1, full, tmp8: ml4, full, tmp2: ml5, full
    # tmp6 = (tmp2 + (M1 M2^T))
