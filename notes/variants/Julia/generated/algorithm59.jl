...
"""
    algorithm59(ml0::Array{Float64,2}, ml1::Array{Float64,2}, ml2::Array{Float64,2}, ml3::Array{Float64,2}, ml4::Array{Float64,2})
...
function algorithm59(ml0::Array{Float64,2}, ml1::Array{Float64,2}, ml2::Array{Float64,2}, ml3::Array{Float64,2}, ml4::Array{Float64,2})
    ...
    # M4: ml3, full, M5: ml4, full, tmp6: ml6, full
    # tmp8 = (M4 + M5)
    axpy!(1.0, ml3, ml4) # matrices

    # tmp6: ml6, full, tmp8: ml4, full
    # tmp5 = (tmp6 + tmp8^T)
    ml6 .+= transpose(ml4)
