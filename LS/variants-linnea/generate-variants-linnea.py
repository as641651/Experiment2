...
def least_squares(m=2500,n=500):
    ...
    # b = inv(X.TX)X.T*y
    equations = Equations(Equal(Y, Times(Inverse(Times(Transpose(X),X)), Transpose(X), y)))
...
if __name__ == "__main__":
    ...
    parser.add_argument('dims', metavar='N', type=int, nargs='+',
                        help='Least square problem, Enter atleast 2 integers. ')
